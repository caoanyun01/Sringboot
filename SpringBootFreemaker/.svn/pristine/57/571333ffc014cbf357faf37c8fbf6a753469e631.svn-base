...
public class CommentController {
	...
	public ModelAndView comment(Param param){
		ModelAndView modelAndView=new ModelAndView();
		List<Comment> comments=ICommentMapper.findComment(param);
		modelAndView.addObject("comments",comments);
		modelAndView.setViewName("comment/molde");
		return modelAndView;
	}
}
